 ...
 */
final class Version20180603165509 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5AB49287A45D93BF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__locastic_comparer AS SELECT id, shop_user_id FROM locastic_comparer');
        $this->addSql('DROP TABLE locastic_comparer');
        $this->addSql('CREATE TABLE locastic_comparer (id INTEGER NOT NULL, shop_user_id INTEGER DEFAULT NULL, token VARCHAR(255) NOT NULL, PRIMARY KEY(id), CONSTRAINT FK_5AB49287A45D93BF FOREIGN KEY (shop_user_id) REFERENCES sylius_shop_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO locastic_comparer (id, shop_user_id) SELECT id, shop_user_id FROM __temp__locastic_comparer');
        $this->addSql('DROP TABLE __temp__locastic_comparer');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5AB49287A45D93BF ON locastic_comparer (shop_user_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_5AB492875F37A13B ON locastic_comparer (token)');
        $this->addSql('DROP INDEX IDX_7553880F4584665A');
        $this->addSql('DROP INDEX IDX_7553880FE1EE8ED8');
        $this->addSql('CREATE TEMPORARY TABLE __temp__locastic_comparer_product AS SELECT id, comparer_id, product_id FROM locastic_comparer_product');
        $this->addSql('DROP TABLE locastic_comparer_product');
        $this->addSql('CREATE TABLE locastic_comparer_product (id INTEGER NOT NULL, comparer_id INTEGER NOT NULL, product_id INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_7553880FE1EE8ED8 FOREIGN KEY (comparer_id) REFERENCES locastic_comparer (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7553880F4584665A FOREIGN KEY (product_id) REFERENCES sylius_product (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO locastic_comparer_product (id, comparer_id, product_id) SELECT id, comparer_id, product_id FROM __temp__locastic_comparer_product');
        $this->addSql('DROP TABLE __temp__locastic_comparer_product');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Comparer (id INTEGER NOT NULL, comparerProducts CLOB NOT NULL COLLATE BINARY --(DC2Type:array)
        , shopUser CLOB DEFAULT NULL COLLATE BINARY --(DC2Type:object)
        , PRIMARY KEY(id))');
        $this->addSql('DROP INDEX UNIQ_5AB492875F37A13B');
        $this->addSql('DROP INDEX UNIQ_5AB49287A45D93BF');
        $this->addSql('CREATE TEMPORARY TABLE __temp__locastic_comparer AS SELECT id, shop_user_id FROM locastic_comparer');
        $this->addSql('DROP TABLE locastic_comparer');
